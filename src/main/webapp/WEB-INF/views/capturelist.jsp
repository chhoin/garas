...
<!-- <html lang="en"> -->
	...
	<body>
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg bg-blue">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-light">បញ្ជីទំនិញនាំចូល</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="#"><span>បញ្ជីទំនិញនាំចូល</span></a></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
									...
									<div class="panel-body">
										<div class="form-wrap">
																		...
																		<div class="form-wrap">
																			<form id="myform" action="#">													
																					<div class="row">
																						...
																						<div class="col-md-3">
																							<div class="form-group">
																								<label class="control-label mb-10">ប្រភេទ</label>
																					        	<div class="form-group has-success">
																									<select class="form-control select2" id="cboType" name = "cboType">
																										<option value="">ជ្រើសរើសប្រភេទ</option>
																										<option value="N">Non-Return</option>
											...
											<div class="row">
												<div class="col-md-12">
													<div class="panel panel-default card-view" style="background-color: #eee;">								
														<h6 class="txt-dark capitalize-font" style="font-size: 14px; color: #566fc9;">បញ្ជីព័ត៌មានទំនិញនាំចូល</h6>
														<div class="clearfix"></div>
														<!-- <hr class="line"> -->
														<hr style="margin-top: 5px; margin-bottom: 1px;">
																				...
																				<table data-toggle="table" class="table table-hover">
																					<thead style="background-color: rgb(86, 111, 201);">
																						<tr>
																							...
																							<th class="txt-light">ថ្ងៃខែឆ្នាំនាំចូល</th>
																							<th class="txt-light">ប្រភេទ</th>
																							...
																							<th class="txt-light">ស្តុកដែលប្រើ</th>
																						    <th class="txt-light">ស្តុកនៅសល់</th>
																							...
																							<th class="txt-light">ព្រីនរបាយការណ៍</th>
																						</tr>
																					</thead>		
													...
													<div class="row">
														<div class="form-body">
															<div class="row">
																<div class="col-md-6">
																	<div class="panel panel-default card-view" style="background-color: #eee;">								
																		<h6 class="txt-dark capitalize-font" style="font-size: 18px; color: #566fc9;">ព័ត៌មានក្រុមហ៊ុន</h6>
																		<div class="clearfix"></div>
																		<!-- <hr class="line"> -->
																		<hr style="margin-top: 5px; margin-bottom: 1px;">
																					...
																					<div class="col-sm-12 col-xs-12">
																						<div class="form-wrap">		
																							...
																							<div class="row">
																								...
																								<div class="col-md-9">
																									<div class="form-group">
																										...
																										<label for="txtInvoiceSupName"></label>
																									</div>
																								</div>
																								<!--/span-->
																							</div>
																							...
																							<div class="row">
																								...
																								<div class="col-md-9">
																									<div class="form-group">
																										<label for="txtInvoicePhone"></label>
																									</div>
																								</div>
																								<!--/span-->
																							</div>
																...
																<div class="col-md-6">
																	<div class="panel panel-default card-view" style="background-color: #eee;">
																		<h6 class="txt-dark capitalize-font" style="font-size: 18px; color: #566fc9;">ព័ត៌មានមុខទំនិញ</h6>
																		<div class="clearfix"></div>
																		<!-- <hr class="line"> -->
																		<hr style="margin-top: 5px; margin-bottom: 1px;">
																					...
																					<div class="col-sm-12 col-xs-12">
																						...
																						<!-- /Row -->
																							...
																							<div class="row">
																								<div class="col-md-3">
																									<div class="form-group">
																										<label class="control-label mb-10">កាត់ចូលស្តុក:</label>
																									</div>
																								</div>
																								<!--/span-->
														       	...
														       	<table data-toggle="table" class="table">
																	<thead style="background-color: rgb(86, 111, 201);">
																		<tr>
																			...
																			<th style="color: red;">ប្រភេទទំនិញ</th>
			...
			<script type="text/javascript" src='<c:url value="/resources/js/capturelist.js"/>'> </script>

...
<!-- <html lang="en"> -->
	...
	<body>
		...
		<!-- Main Content -->
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg bg-blue">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-light">អតិថិជនជំពាក់</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								<li><a href="index.html">គ្រប់គ្រងប្រេង</a></li>
								<li><a href="#"><span>អតិថិជនជំពាក់</span></a></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								...
								<div class="panel-heading">
									<div class="pull-left">
										<h4 class="panel-title txt-dark" style="font-size: 16px;">អតិថិជនជំពាក់</h4>
									</div>
									<div class="pull-right">
										<a href='<c:url value="/customercapture"/>'>
											<button class="btn btn-primary btn-rounded btn-icon left-icon" style="margin-top: 15px;">
												<i class="glyphicon glyphicon-plus "></i> 
												<span>ទំនិញលក់ចេញ</span>
											</button>
										</a>
										...
										<a href='<c:url value="/customerinvoicelist"/>'>
											<button class="btn btn-primary btn-rounded btn-icon left-icon" style="margin-top: 15px;">
												<i class="ti-menu-alt "></i>
												<span>បញ្ជីអតិថិជនជំពាក់</span>
											</button>
										</a>
									</div>
											...
											<div class="col-sm-12 col-xs-12">
												<div class="form-wrap">
													<form id="myform" action="#">
														<div class="form-body">
															<h6 class="txt-dark capitalize-font" style="font-size: 14px;" style="font-weight: bold; font-size: 16px; color: #566fc9;"><i class="ti-menu-alt mr-10"></i>បញ្ចូលព័ត៌មានអតិថិជនជំពាក់</h6>
															<hr>
															<div class="row">
																<div class="col-md-4">
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<div class="form-group has-success">
																			<input type="text" id="txtCustomer" name = "txtCustomer" class="form-control" placeholder="ឈ្មោះអតិថិជន">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
															...
															<div class="row">
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<div class="form-group has-success">
																			<input type="text" id="txtCcy" name = "txtCcy" class="form-control" placeholder="ប្រភេទរូបិយប័ណ្ណ" readonly="readonly">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
																...
																<div class="col-sm-4">
															        <div class="form-group">
															        	<label class="control-label mb-10">ថ្ងៃខែឆ្នាំជំពាក់ <span class ="star"> ***</span></label>
															...
															<div class="row">
																...
																<div class="col-md-4">
																	<div class="form-group">
																		<label class="control-label mb-10">នៅជំពាក់សរុប  </label>
																		<div class="form-group has-success">
																			<input type="text" id="txtAmount" class="form-control" readonly="readonly" placeholder="នៅជុំពាក់សរុប">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
			...
			<script type="text/javascript" src='<c:url value="/resources/js/customer_invoice.js"/>'> </script>

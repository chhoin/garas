...
<!-- <html lang="en"> -->
	...
	<body>
		...
		<!-- Main Content -->
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg bg-blue">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-light">ចំណាយផ្សេងៗ</h5>
						</div>
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h4 class="panel-title" style="font-size: 18px; color: blue;">បញ្ចូលព័ត៌មានចំណាយផ្សេងៗ</h4>
									</div>
									<div class="pull-right">
										<a href='<c:url value="/expenselist"/>'>
											<button class="btn btn-primary btn-rounded btn-icon left-icon"> 
												<i class="ti-menu-alt "></i> 
												<span>បញ្ជីព័ត៌មានចំណាយផ្សេងៗ</span>
											</button>
										</a>
									</div>
											...
											<div class="col-sm-12 col-xs-12">
												<div class="form-wrap">
													<form id="myform" action="#">
														<div class="form-body">
															<h6 class="txt-dark capitalize-font" style="font-size: 14px;"><i class="ti-menu-alt mr-10"></i>បញ្ចូលព័ត៌មានចំណាយផ្សេងៗ</h6>
															<hr>
															
															<div class="row">
																<div class="col-md-6">
																	<div class="form-group">
																		<label class="control-label mb-10">ប្រភេទចំណាយ<span class ="star"> ***</span></label>
																		<div class="form-group has-success">
																			<input type="text" class="form-control" id="txtIncomeType" name = "txtIncomeType" placeholder="ប្រភេទចំណាយ">
																...
																<div class="col-sm-6">
															        <div class="form-group">
															        	<label class="control-label mb-10">ថ្ងៃខែឆ្នាំចំណាយ<span class ="star"> ***</span></label>
			...
			<script type="text/javascript" src='<c:url value="/resources/js/expense.js"/>'> </script>

...
<!-- <html lang="en"> -->
	...
	<body>
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg bg-blue">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-light">បញ្ជីចំណាយផ្សេងៗ</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="#"><span>បញ្ជីចំណាយផ្សេងៗ</span></a></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
									...
									<div class="panel-body">
										<div class="form-wrap">
																						...
																						<div class="col-md-6">
																							<div class="form-group">
																					        	...
																					        	<div class="form-group has-success">
																									<select class="form-control select2" id="cboExpenseType" name = "cboExpenseType">
											...
											<div class="row">
												<div class="col-md-12">
													<div class="panel panel-default card-view" style="background-color: #eee;">								
														<h6 class="txt-dark capitalize-font" style="font-size: 14px; color: #566fc9;">បញ្ជីព័ត៌មានចំណាយផ្សេងៗ</h6>
														<div class="clearfix"></div>
														<!-- <hr class="line"> -->
														<hr style="margin-top: 5px; margin-bottom: 1px;">
			...
			<script type="text/javascript" src='<c:url value="/resources/js/expenselist.js"/>'> </script>

...
<!-- <html lang="en"> -->
	...
	<body>
		...
		<!-- Main Content -->
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg bg-blue">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-light">បញ្ជីព័ត៌មានចំណេញខាត</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="#"><span>បញ្ជីព័ត៌មានចំណេញខាត</span></a></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
										...
										<div class="row">
											<div class="col-sm-12 col-xs-12">
												<div class="form-wrap">
													<form action="#">
														<div class="form-body">
															<h6 class="txt-dark capitalize-font" style="font-size: 14px; color: #566fc9;"><i class="glyphicon glyphicon-th-list mr-10"></i>បញ្ជីព័ត៌មានចំណេញខាតសរុប</h6>
															<div class="clearfix"></div>
															<hr>
															<div class="row">
																<div class="col-md-12">
																	<div class="form-group">
																		...
																		<table data-toggle="table" class="table table-hover">
																			<thead style="background-color: rgb(86, 111, 201);">
																				<tr>
														                            <th class="txt-light">បរិយាយប្រភេទ</th>
																					<th class="txt-light">រូបិយប័ណ្ណ</th> 
																					<th class="txt-light">ចំនួនសរុបជាប្រាក់ដុល្លារ</th>
																					<th class="txt-light">ចំនួនសរុបជាប្រាក់រៀល</th>
																				</tr>
																			</thead>
																			<!-- #337ab7; -->
			...
			<script type="text/javascript" src='<c:url value="/resources/js/gainloss.js"/>'> </script>

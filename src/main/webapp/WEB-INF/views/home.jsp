...
<!-- Clear Form -->
	<script type="text/javascript" src='<c:url value="/resources/TestDate/css/jquery-1.12.3.min.js"/>'></script>
	
	<!-- Validate -->
	<script type="text/javascript" src='<c:url value="/resources/TestDate/css/jquery.validate.min.js"/>'></script>
	
	<!-- Datepicker -->
	<link rel="stylesheet" href='<c:url value="/resources/TestDate/css/jquery-ui.css"/>'> 	
	<script type="text/javascript" src='<c:url value="/resources/TestDate/css/jquery-ui.min.js"/>'></script>
	<script type="text/javascript" src='<c:url value="/resources/TestDate/css/moment.min.js"/>'></script>

...
<!-- <html lang="en"> -->
	...
	<body>
		...
		<!-- Main Content -->
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg bg-blue">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-light">ស្វែងរកព័ត៌មានមុខទំនិញ</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="#"><span>បញ្ជីព័ត៌មានមុខទំនិញ</span></a></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
												...
												<div class="col-sm-3">
											        <div class="form-group">
											        	...
											        	<div class="form-group has-success">
															<select class="form-control" id="cboSName" name = "cboSName">
										...
										<div class="row">
											<div class="col-sm-12 col-xs-12">
												<div class="form-wrap">
													<form action="#">
														<div class="form-body">
															<h6 class="txt-dark capitalize-font" style="font-size: 14px; color: #566fc9;"><i class="glyphicon glyphicon-th-list mr-10"></i>បញ្ជីព័ត៌មានមុខទំនិញ</h6>
															<div class="clearfix"></div>
															<hr>
															<div class="row">
																<div class="col-md-12">
																		...
																		<table data-toggle="table" class="table table-hover">
																			<thead style="background-color: rgb(86, 111, 201);">
																				<tr>
																					 ...
																					 <th class="txt-light">តំលៃដើមនាំចូល</th>
																					 <th class="txt-light">ចំនូនទំនិញសរុប</th>
																					 <th class="txt-light">រូបិយប័ណ្ណ</th>
																					 <th class="txt-light">ជូនដំណឹង</th>
																					 <th class="txt-light">ថ្ងៃខែឆ្នាំនាំចូល</th>
																					 <th class="txt-light">ឈ្មោះអ្នកបញ្ចូលព័ត៌មាន</th>
																					 <th class="txt-light">ថ្ងៃខែឆ្នាំបញ្ចូលព័ត៌មាន</th>
		    ...
		    <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
		     	<div class="modal-dialog">
				    <div class="modal-content">
			          <div class="modal-header">
				        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				        <h4 class="modal-title custom_align" id="Heading">លុបព័ត៌មានមុខទំនិញ</h4>
				      </div>
				      
			          <div class="modal-body has-success">
				       	<div class="alert alert-danger">
				       		<span class="glyphicon glyphicon-warning-sign">
				       		</span> តើអ្នកពិតជាចង់លុបព័ត៌មានមុខទំនិញ 
				       		<samp>
			...
			<script type="text/javascript" src='<c:url value="/resources/js/product_list.js"/>'> </script>

				...
				<div class="container-fluid">
					...
					<div class="row heading-bg bg-blue">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-light">ជួនដំណឹងព័ត៌មានស្តុក</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								<li><a href="index.html">គ្រប់គ្រងប្រេង</a></li>
								<li><a href="#"><span>ជួនដំណឹងព័ត៌មានស្តុក</span></a></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h4 class="panel-title txt-dark" style="font-size: 16px;">ជួនដំណឹងព័ត៌មានស្តុក</h4>
									</div>
													...
													<form action="#">
														<div class="form-body">
															...
															<div class="row">
																<div class="col-md-8">
																	<div class="form-group">
																		<label class="control-label col-md-3">ប្រភេទមុខទំនិញ</label>
																		<div class="col-md-9 has-success">
																			<select class="form-control" id ="cboUnit">
																				<option value=""></option>
																				<option value="">ជំពាក់</option>
																				<option value="">ខូចខាត</option>
																				<option value="">បាត់បង់</option>
																			</select>
															...
															<div class="row">
																<div class="col-md-8">
																	<div class="form-group">
																		<label class="control-label col-md-3">ឈ្មោះមុខទំនិញ<span class ="star"> ***</span></label>
																		<div class="col-md-9 has-success">
																			<select class="form-control" id ="cboUnit">
																				<option value=""></option>
																				<option value="">ជំពាក់</option>
															...
															<div class="row">
																<div class="col-md-8">
																	<div class="form-group">
																		<label class="control-label col-md-3">ចំនួនអោយដំណឹង <span class ="star"> ***</span></label>
																		<div class="col-md-9 has-success">
																			<input type="text" id="txtbuy" class="form-control" placeholder="ចំនួនអោយដំណឹង">
																			<span class="help-block"></span>
																		</div>
																	</div>
																</div>
															...
															<div class="row">
																<div class="col-md-12 ">
																	<div class="form-actions mt-10">
																		<button type="submit" id="bSave" class="btn btn-primary btn-rounded btn-icon left-icon"> <i class="ti-save"></i> <span>រក្សាទុក</span></button>

				...
				<div class="container-fluid">
					...
					<div class="row heading-bg bg-blue">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-light">ព័ត៌មានអ្នកផ្គត់ផ្គង់</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="#"><span>ព័ត៌មានអ្នកផ្គត់ផ្គង់</span></a></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h4 class="panel-title" style="font-size: 18px; color: blue;">បញ្ចូលព័ត៌មានអ្នកផ្គត់ផ្គង់</h4>
									</div>
									<div class="pull-right">
										<a href='<c:url value="/supplierlist"/>'>
											<button class="btn btn-primary btn-rounded btn-icon left-icon"> 
												<i class="ti-menu-alt "></i> 
												<span>បញ្ជីព័ត៌មានអ្នកផ្គត់ផ្គង់</span>
											</button>
										</a>
									</div>
											...
											<div class="col-sm-12 col-xs-12">
												<div class="form-wrap">
													<form id="myform" action="#">
														<div class="form-body">
															<h6 class="txt-dark capitalize-font" style="font-size: 14px;"><i class="ti-menu-alt mr-10"></i>បញ្ចូលព័ត៌មានអ្នកផ្គត់ផ្គង់</h6>
															<hr>
															
															<div class="row">
																<div class="col-md-4">
																	<div class="form-group">
																		<label class="control-label mb-10">ឈ្មោះក្រុមហ៊ុន <span class ="star"> ***</span> </label>
																		<div class="form-group has-success">
																			<input type="text" class="form-control" id="txtCompany" name = "txtCompany" placeholder="ឈ្មោះក្រុមហ៊ុន">
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<div class="form-group has-success">
																			<input type="text" class="form-control" id="txtKhName" name = "txtKhName" placeholder="ឈ្មោះអ្នកផ្គត់ផ្គង់">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
																...
																<div class="col-md-4">
																	<div class="form-group">
																		<label class="control-label mb-10">ឈ្មោះជាអក្សរឡាតាំង </label>
																		<div class="form-group has-success">
																			<input type="text" class="form-control" id="txtEngName" name = "txtEngName" placeholder="ឈ្មោះជាអក្សរឡាតាំង">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
															...
															<div class="row">
																...
																<div class="col-md-4">
																	<div class="form-group">
																		<label class="control-label mb-10">អ៊ីម៉ែល </label>
																		<div class="form-group has-success">
																			<input type="text" class="form-control" id="txtMail" name = "txtMail" placeholder="អ៊ីម៉ែល">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<div class="form-group has-success">
																			<input type="text" class="form-control" id="txtAddress" name = "txtAddress" placeholder="អាស័យដ្ឋាន ">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>

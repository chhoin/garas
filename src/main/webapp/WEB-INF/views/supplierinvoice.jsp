...
<!-- <html lang="en"> -->
	...
	<body>
		...
		<!-- Main Content -->
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg bg-blue">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-light">ជំពាក់អ្នកផ្គត់ផ្គង់</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								<li><a href="index.html">គ្រប់គ្រងប្រេង</a></li>
								<li><a href="#"><span>ជំពាក់អ្នកផ្គត់ផ្គង់</span></a></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h4 class="panel-title txt-dark" style="font-size: 16px;">បញ្ចូលជំពាក់អ្នកផ្គត់ផ្គង់</h4>
									</div>
									<div class="pull-right">
										...
										<a href='<c:url value="/supplierpayable"/>'>
											<button class="btn btn-primary btn-rounded btn-icon left-icon" style="margin-top: 15px;">
												<i class="glyphicon glyphicon-plus "></i> 
												<span>សងជំពាក់អ្នកផ្គត់ផ្គង់</span>
											</button>
										</a>
											...
											<div class="col-sm-12 col-xs-12">
												<div class="form-wrap">
													<form id="myform" action="#">
														<div class="form-body">
															<h6 class="txt-dark capitalize-font" style="font-size: 14px;" style="font-weight: bold; font-size: 16px; color: #566fc9;"><i class="ti-menu-alt mr-10"></i>បញ្ចូលព័ត៌មានជំពាក់អ្នកផ្គត់ផ្គង់</h6>
															<hr>
															...
															<div class="row">
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<div class="form-group has-success">
																			<select class="form-control" id ="txtInvoice" name = "txtInvoice">
																				<option value=""></option>
																			</select>
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<div class="form-group has-success">
																			<input type="text" id="txtSupplier" name = "txtSupplier" class="form-control" readonly="readonly" placeholder="ឈ្មោះអ្នកផ្គត់ផ្គង់">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<div class="form-group has-success">
																			<input type="text" id="txtPhone" name = "txtPhone" class="form-control" readonly="readonly" placeholder="លេខទូរស័ព្ទ">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
															...
															<div class="row">
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<div class="form-group has-success">
																			<input type="text" id="txtCcy" name = "txtCcy" class="form-control" placeholder="រូបិយប័ណ្ណ" readonly="readonly">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
																...
																<div class="col-sm-4">
															        <div class="form-group">
															        	<label class="control-label mb-10">ថ្ងៃខែឆ្នាំជំពាក់ប្រាក់ <span class ="star"> ***</span></label>
																...
																<div class="col-sm-4">
															        <div class="form-group">
															        	<label class="control-label mb-10">ថ្ងៃខែឆ្នាំសងត្រលប់<span class ="star"> ***</span></label>
															...
															<div class="row">
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<div class="form-group has-success">
																			<input type="text" id="txtCategory" name = "txtCategory" class="form-control" readonly="readonly" placeholder="ប្រភេទទំនិញ">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<div class="form-group has-success">
																			<input type="text" id="txtUnit" name = "txtUnit" class="form-control" readonly="readonly" placeholder="តំលៃក្នុងមួយលីត្រ">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<div class="form-group has-success">
																			<input type="text" id="txtQty" name = "txtQty" class="form-control" readonly="readonly" placeholder="ចំនួនប្រេងសរុប">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
															...
															<div class="row">
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<div class="form-group has-success">
																			<input type="text" id="txtTotal" name = "txtTotal" class="form-control" readonly="readonly" placeholder="ទឹកប្រាក់សរុប">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<div class="form-group has-success">
																			<input type="text" id="txtPay" name = "txtPay" class="form-control" placeholder="ទឹកប្រាក់បានសង ">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<div class="form-group has-success">
																			<input type="text" id="txtAmount" class="form-control" readonly="readonly" placeholder="0">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
			...
			<script type="text/javascript" src='<c:url value="/resources/js/supplierinvoice.js"/>'> </script>

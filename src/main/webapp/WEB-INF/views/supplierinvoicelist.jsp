...
<!-- <html lang="en"> -->
	...
	<body>
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg bg-blue">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-light">បញ្ជីជំពាក់ក្រុមហ៊ុន</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="#"><span>បញ្ជីជំពាក់ក្រុមហ៊ុន</span></a></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
									...
									<div class="panel-body">
										<div class="form-wrap">
											...
											<div class="row">
												<div class="col-md-12">
													<div class="panel panel-default card-view" style="background-color: #eee;">								
														<h6 class="txt-dark capitalize-font" style="font-size: 14px; color: #566fc9;">បញ្ជីព័ត៌មានជំពាក់ក្រុមហ៊ុន</h6>
														<div class="clearfix"></div>
														<!-- <hr class="line"> -->
														<hr style="margin-top: 5px; margin-bottom: 1px;">
				    ...
				    <div class="modal-content">
			          ...
			          <div class="modal-body has-success">
				       	<table data-toggle="table" class="table table-hover">
							...
							<tbody id="tblCusCaptures" style="color: black;"></tbody>
						</table>
				      </div>
        	...
        	<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
		      <div class="modal-dialog" style="width: 700px;">
			    <div class="modal-content">
			          <div class="modal-header" style="background-color: #3cb878;">
				        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				        <h5 class="modal-title custom_align" id="Heading" style="color: white;">សងជំពាក់ក្រុមហ៊ុន</h5>
				      </div>
			...
			<script type="text/javascript" src='<c:url value="/resources/js/supplierinvoicelist.js"/>'> </script>

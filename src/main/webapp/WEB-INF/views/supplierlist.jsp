...
<!-- <html lang="en"> -->
	...
	<body>
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg bg-blue">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-light">ស្វែងរកព័ត៌មានអ្នកផ្គត់ផ្គង់</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="#"><span>បញ្ជីព័ត៌មានអ្នកផ្គត់ផ្គង់</span></a></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
																		...
																		<table data-toggle="table" class="table table-hover">
																			<thead style="background-color: rgb(86, 111, 201);">
																				<tr>
																					...
																					<th class="txt-light">ឈ្មោះអ្នកប្រគល់</th>
																					<th class="txt-light">លេខទូរស័ព្ទ</th>
																					<th class="txt-light">អ៊ីម៉ែល</th>
        	...
        	<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
		      <div class="modal-dialog">
			    <div class="modal-content">
		          <div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			        <h4 class="modal-title custom_align" id="Heading">កែប្រែព័ត៌មានអ្នកផ្គត់ផ្គង់</h4>
			      </div>
		          <div class="modal-body">
			          	<div class="form-group">
			          	...
			          	<div class="form-group">
				        	<input class="form-control " type="text" id="txtUpdateName" name = "txtUpdateName" placeholder="ឈ្មោះអ្នកផ្គត់ផ្គង់">
				        </div>
				        <div class="form-group">
				        	<input class="form-control " type="text" id="txtUpdatePhone" name = "txtUpdatePhone" placeholder="លេខទូរស័ព្ទ">
				        </div>
			      </div>
		         	<div class="modal-footer ">
		...
		<script type="text/javascript" src='<c:url value="/resources/js/supplierlist.js"/>'> </script>

...
<!-- <html lang="en"> -->
	...
	<body>
		...
		<!-- Main Content -->
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg bg-blue">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-light">សងប្រាក់អ្នកផ្គត់ផ្គង់</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								<li><a href="index.html">គ្រប់គ្រងប្រេង</a></li>
								<li><a href="#"><span>សងប្រាក់អ្នកផ្គត់ផ្គង់</span></a></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
						...
						<div class="col-md-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h4 class="panel-title txt-dark" style="font-size: 16px;">សងប្រាក់អ្នកផ្គត់ផ្គង់</h4>
									</div>
											...
											<div class="col-sm-12 col-xs-12">
												<div class="form-wrap">
													<form id="myform" action="#">
														<div class="form-body">
															<h6 class="txt-dark capitalize-font" style="font-size: 14px;" style="font-weight: bold; font-size: 16px; color: #566fc9;"><i class="ti-menu-alt mr-10"></i>បញ្ចូលព័ត៌មានសងប្រាក់អ្នកផ្គត់ផ្គង់</h6>
															<hr>
															<div class="row">
																<div class="col-md-4">
															...
															<div class="row">
																...
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<div class="form-group has-success">
																			<input type="text" id="txtQtyAmount" name = "txtQtyAmount" class="form-control" readonly="readonly" placeholder="ទឹកប្រាក់សរុប">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
															...
															<div class="row">
																<div class="col-md-4">
																	<div class="form-group">
																		...
																		<div class="form-group has-success">
																			<input type="text" id="txtTotalAmount" name = "txtTotalAmount" class="form-control" readonly="readonly" placeholder="0">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
																...
																<div class="col-md-4">
																	<div class="form-group">
																		<label class="control-label mb-10">ទឹកប្រាក់នៅជំពាក់  </label>
																		<div class="form-group has-success">
																			<input type="text" id="txtBalance" name = "txtBalance" class="form-control" placeholder="ទឹកប្រាក់នៅជំពាក់ " readonly="readonly">
																			<!-- <span class="help-block"> This is inline help </span>  -->
																		</div>
																	</div>
																</div>
        	...
        	<!-- call js file -->
			<script type="text/javascript" src='<c:url value="/resources/js/SupplierPayable.js"/>'> </script>

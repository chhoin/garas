...
<!-- <html lang="en"> -->
	...
	<body>
		...
		<!-- Main Content -->
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg bg-blue">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-light">បញ្ជីសងប្រាក់អ្នកផ្គត់ផ្គង់</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="#"><span>បញ្ជីសងប្រាក់អ្នកផ្គត់ផ្គង់</span></a></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
												...
												<div class="pull-left">
													...
													<div class="col-sm-3">
												        <div class="form-group">
												        	...
												        	<div class="form-group has-success">
																<select class="form-control select2" id="cboSupplier" name = "cboSupplier">
																	<option value=""></option>
													...
													<div class="col-sm-1">
												        <div class="form-group">
												        	<div class="form-group has-success" style="margin-top: 35px;">
										...
										<div class="row">
											<div class="col-sm-12 col-xs-12">
												<div class="form-wrap">
													<form action="#">
														<div class="form-body">
															<h6 class="txt-dark capitalize-font" style="font-size: 14px; color: #566fc9;"><i class="glyphicon glyphicon-th-list mr-10"></i>បញ្ជីព័ត៌មានសងប្រាក់អ្នកផ្គត់ផ្គង់</h6>
															<div class="clearfix"></div>
															<hr>
															<div class="row">
																<div class="col-md-12">
																		...
																		<table data-toggle="table" class="table table-hover">
																			<thead style="background-color: rgb(86, 111, 201);">
																				<tr>
																					...
																					<th class="txt-light">ឈ្មោះក្រុមហ៊ុន</th>
																					...
																					<th class="txt-light">បានសងជាប្រាក់ដុល្លារ</th>
																					<th class="txt-light">បានសងជាប្រាក់រៀល</th>
																					<th class="txt-light">ថ្ងៃខែឆ្នាំសងប្រាក់</th>
			...
			<script type="text/javascript" src='<c:url value="/resources/js/supplierpayablelist.js"/>'> </script>

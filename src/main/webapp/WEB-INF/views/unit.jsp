...
<!-- <html lang="en"> -->
	...
	<body>
		...
		<!-- Main Content -->
				...
				<div class="container-fluid">
					...
					<div class="row heading-bg bg-blue">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<h5 class="txt-light">ព័ត៌មានឈ្មោះឯកតា</h5>
						</div>
						...
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
							<ol class="breadcrumb">
								...
								<li><a href="#"><span>ប្រភេទឯកតា</span></a></li>
							</ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
												...
												<div class="row">
													<div class="col-md-4">
														<div class="form-group has-success">
															<label class="control-label mb-10">ឈ្មោះឯកតា</label>
															<input type="text"​ id = "txtUnit" name = "txtUnit"  class="form-control filled-input rounded-input" placeholder="ឈ្មោះឯកតា">
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group has-success">
										...
										<div class="row">
											<div class="col-sm-12 col-xs-12">
												<div class="form-wrap">
													<!-- <form action="#"> -->
														<div class="form-body">
															<h6 class="txt-dark capitalize-font" style="font-size: 14px; color: #566fc9;"><i class="glyphicon glyphicon-th-list mr-10"></i>បញ្ជីព័ត៌មានឈ្មោះឯកតា</h6>
				    ...
				    <div class="modal-content">
			          ...
			          <div class="modal-body has-success">
				       	<div class="alert alert-danger">
				       		...
				       		</span> តើអ្នកពិតជាចង់លុបព័ត៌មានឯកតា 
				       		<samp>
			...
			<script type="text/javascript" src='<c:url value="/resources/js/unit.js"/>'> </script>

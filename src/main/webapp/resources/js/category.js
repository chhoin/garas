...
$(document).ready(function() {
		...
		if ( isValid ){
	    	...
	    	$.ajax({
	    	    ...
	    	    success: function(response){
	    	    	if (response === true){
	    	           alert("Category Exit, Please Check");
	    	        }else{
	    	        	var data = {
	    	        			"categories_NAME": $("#txtType").val(),
	...
	$("#btnDelete").on("click", function() {
		var $this = $(this);
		var categories_CODE = $("label[for='myalue']").text();
		var url = baseUrl + "api/categorysdelete/" + categories_CODE;
